...
#Install Tiny Core extentions
tce-load -i /usr/local/tce.installed/*.tcz

#Execution of the APZ customization script
sudo /usr/local/tce.installed/apz_cloud_init.sh
