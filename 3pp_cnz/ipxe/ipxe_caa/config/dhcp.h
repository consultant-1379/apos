/*** Changelog:
* - Thu May 25 2017 - Pranshu Sinha(XPRANSI)
*  Below mentioned timeout values are changed as per APZ requirements:
*  DHCP_DISC_START_TIMEOUT_SEC,DHCP_DISC_END_TIMEOUT_SEC,DHCP_DISC_PROXY_TIMEOUT_SEC,DHCP_REQ_START_TIMEOUT_SEC,DHCP_REQ_END_TIMEOUT_SEC,
*  DHCP_PROXY_END_TIMEOUT_SEC,DHCP_REQ_PROXY_TIMEOUT_SEC,PXEBS_START_TIMEOUT_SEC,PXEBS_END_TIMEOUT_SEC,PXEBS_MAX_TIMEOUT_SEC 
*/
 ...
 */
#define DHCP_DISC_START_TIMEOUT_SEC 	0
...
#define DHCP_REQ_END_TIMEOUT_SEC    2
...
#define DHCP_PROXY_END_TIMEOUT_SEC	2
 ...
 */
#define DHCP_REQ_PROXY_TIMEOUT_SEC	1
...
#define PXEBS_END_TIMEOUT_SEC		2
 ...
 */
#define PXEBS_MAX_TIMEOUT_SEC		1
