...
##
# Changelog:
# - 2019 Jul 17 - Yeswanth Vankayala (xyesvan)
#       Timeout was set to 25 min due to TR Fix HX69873
...
function set_timeout(){
 ...
 # Hence, the timeout is increased to 20m in this case. 25m=1500000000000 nanoseconds
 kill_after_try 3 1 5 /usr/bin/immcfg  -a smfCliTimeout=1500000000000 smfConfig=1,safApp=safSmfService &> /dev/null 
 apos_log "$HW_TYPE: smfCliTimeout = 1500000000000"
