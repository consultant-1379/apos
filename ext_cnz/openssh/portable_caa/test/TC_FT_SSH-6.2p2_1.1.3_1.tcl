#######################################################################################################
# :Title script that check the functionality of OPENSSH 6.2p : SFTP functionality with user syssecadmin
#
#------------------------------------------------------------------------------------------------------
# :TestAct  
# :SubSys   	
...
#     
#############################################################################################
# :commands to verify SFTP functionality with LDAP user syssecadmin
# --------------------------------------------------------------
#     
#############################################################################################
package require ATH
...
print "\n"
print "SFTP functionality with user $SUT::APG1_COM_USER_3\n"
print "\n"
print "*************************************************************\n"
...
ath_send "sudo -u $SUT::APG1_TS_USER  cp /tmp/TS_USER1_SFTP_TEST.txt /data/opt/ap/nbi_fuse/etc/"

ath_send "sudo -u $SUT::APG1_TS_USER  ls -la /data/opt/ap/nbi_fuse/etc/TS_USER1_SFTP_TEST.txt"

ath_send "sudo -u $SUT::APG1_TS_USER  cat /data/opt/ap/nbi_fuse/etc/TS_USER1_SFTP_TEST.txt"
...
remote:/etc/TS_USER1_SFTP_TEST.txt => local:TS_USER1_SFTP_TEST.txt
:"
...
rm /etc/TS_USER1_SFTP_TEST.txt: permission denied
:"
...
/etc/TS_USER1_SFTP_TEST.txt: permission denied
:"
...
ath_send_ftp "rm /etc/TS_USER1_SFTP_TEST.txt"

ath_display $ATH::LastResponse

set patternSftpTestFilerm ":
rm /etc/TS_USER1_SFTP_TEST.txt: OK
:"
