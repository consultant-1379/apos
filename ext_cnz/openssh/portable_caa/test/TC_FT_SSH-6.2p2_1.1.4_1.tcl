###################################################################################################
# :Title script that check the functionality of OPENSSH 6.2p : SFTP functionality with user sysuser
#
#--------------------------------------------------------------------------------------------------
# :TestAct  
# :SubSys   	
...
#     
#############################################################################################
# :commands to verify SFTP functionality with LDAP user sysuser
# --------------------------------------------------------------
#     
#############################################################################################
package require ATH
...
print "\n"
print "SFTP functionality with user $SUT::APG1_COM_USER_2\n"
print "\n"
print "*************************************************************\n"
...
ath_send "echo \"QGIUPON\" > TS_USER1_SFTP_TEST.txt"
...
ath_login_sftp "$SUT::APG1_COM_USER_2" "$SUT::APG1_COM_PW_2"
