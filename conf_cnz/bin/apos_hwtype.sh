...
#       apos_hwtype.sh
# Description:
#       A script to detect the current hardware revision.
#       It tries to detect if we are running on GEP1, GEP2, ..., GEPn or VM.
# Note:
#	None.
##
# Usage:
...
# Output:
#     
#  Output (assuming $GEP_PREFIX=="GEP" and $VM=="VM"):
#               "GEP1" or
#               "GEP2" or
#               ... or
#               "GEPn" or
...
##
# Changelog:
# - Wed Aug 17 2022 - Swapnika Baradi (xswapba)
#       Fx for Manufacturer of CEE10.1 is ericsson ab in identify function
# - Fri Dec 15 2017 - Raghavendra Koduri (xkodrag)
#       Detection of hardware for Red hat openstack platform
# - Tue Feb 02 2016 - Gianluca Santoro (eginsan)
#	Unsupported manufacturer case improved, NO_HWTYPE error removed.
# - Mon Feb 01 2016 - Francesco Rainone (efrarai)
#   Added the "innotek" case to cover VirtualBox virtual environment.
# - Wed Jan 27 2016 - Gianluca Santoro (eginsan)
#	Backtick removed. Code improved.
# - Mon Apr 29 2013 - Francesco Rainone (efrarai)
#	CPU usage improvement.
# - Tue Jan 31 2012 - Paolo Palmieri (epaopal)
#	Script rework.
# - Thu Sep 01 2011 - Francesco Rainone (efrarai)
#	Manufacturer detection improved and introduction of the NO_HWTYPE error.
# - Wed Dec 29 2010 - Francesco Rainone (efrarai)
#	First version.
##
...
function identify(){
    ...
    if [ -z "$VIRT_ENV" ]; then
        apos_abort "unsupported hypervisor found: \"$VIRT_ENV\""
    else
        apos_log "Detected Hypervisor \"$VIRT_ENV\" and detected manufacturer \"$MANUFACTURER\" "
