...
static APOS_HA_RdeAgent_AmfClass* appMngrObj =NULL;
...
class ACS_APGCC_AMFCallbacks {
	...
	private:
		...
		==================================================================== */
		//static APOS_HA_RdeAgent_AmfClass* appMngrObj;
	...
	public:
		...
		@param	APOS_HA_RdeAgent_AmfClass
		...
		*/
		/*=================================================================== */
		ACS_APGCC_ReturnType safAMFInitialize ( APOS_HA_RdeAgent_AmfClass *);
...
/* ================================================================== 
   ...
   ================================================================== */
//APOS_HA_RdeAgent_AmfClass* ACS_APGCC_AMFCallbacks::appMngrObj = NULL;
		
/*=================================================================== 
   ROUTINE: safAMFInitialize
=================================================================== */

ACS_APGCC_ReturnType ACS_APGCC_AMFCallbacks::safAMFInitialize(APOS_HA_RdeAgent_AmfClass *obj){
...
void ACS_APGCC_AMFCallbacks::coremw_csi_set_callback (	SaInvocationT p_Inv, //IN
	...
	if (p_HAState == SA_AMF_HA_QUIESCING) {
		...
		if ( SA_AIS_OK != errCode ){ 
			syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:coremw_csi_set_callback:saAmfCSIQuiescingComplete FAILED");
	...
	if ( SA_AIS_OK != errCode ) {
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:coremw_csi_set_callback:saAmfResponse FAILED");
		appMngrObj->HAState = previousHAState;
		return ;
	}
...
void ACS_APGCC_AMFCallbacks::coremw_csi_remove_callback (SaInvocationT p_Inv,   	// IN
	...
	if (SA_AIS_OK != errCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:coremw_csi_remove_callback:saAmfResponse FAILED");
		return;
	}			
...
void ACS_APGCC_AMFCallbacks::coremw_csi_terminate_callback( SaInvocationT p_Inv ,  // IN
	...
	if (SA_AIS_OK != errCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:coremw_csi_terminate_callback:saAmfResponse FAILED");
		return ;
	}	
...
void ACS_APGCC_AMFCallbacks::coremw_healthcheck_callback(	SaInvocationT p_Inv,		// IN
	...
	if (  ACS_APGCC_FAILURE != errorCode) {							
		...
		if (SA_AIS_OK != errCode) {
			syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:coremw_healthcheck_callback:saAmfResponse FAILED");
		}		
	}
}	/* end coremw_healthcheck_callback */

/*=================================================================== 
			APOS_HA_RdeAgent_AmfClass CLASS IMPLEMENTATION
=================================================================== */

int APOS_HA_RdeAgent_AmfClass::shutdownPipeFd[2];
char APOS_HA_RdeAgent_AmfClass::__pidfile[PID_FILE_LEN];

/*=================================================================== 
   ROUTINE: APOS_HA_RdeAgent_AmfClass  - Constructor 
=================================================================== */		
APOS_HA_RdeAgent_AmfClass::APOS_HA_RdeAgent_AmfClass(const char* daemon_name,
...
} /* end APOS_HA_RdeAgent_AmfClass */

/*=================================================================== 
   ROUTINE:  coreMWInitialize
=================================================================== */	

ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::coreMWInitialize( ){
	...
	if (SA_AIS_OK != errorCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:saAmfSelectionObjectGet FAILED");
		return ACS_APGCC_FAILURE;
	}
	...
	if (SA_AIS_OK != errorCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:saAmfCompNameGet FAILED");
		return ACS_APGCC_FAILURE;
	}
	...
	if (SA_AIS_OK != errorCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:componentRegister FAILED");
		return ACS_APGCC_FAILURE;
	}							
	...
	if (SA_AIS_OK != errorCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:Application healthcheckStart FAILED");
		return ACS_APGCC_FAILURE;
	}							
...
ACS_APGCC_AMF_HA_StateT APOS_HA_RdeAgent_AmfClass::getHAState (void ) const {
...
ACS_APGCC_SelObjT APOS_HA_RdeAgent_AmfClass::getSelObj(void ) const {
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::componentReportError ( ACS_APGCC_AMF_RecommendedRecoveryT rRecovery) { // IN
	...
	if (SA_AIS_OK != errorCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:saAmfComponentErrorReport FAILED");
		return  ACS_APGCC_FAILURE ;
	}
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::componentClearError( ){
	...
	if (SA_AIS_OK != errorCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:saAmfComponentErrorClear FAILED");
		return ACS_APGCC_FAILURE ;
	}
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::dispatch(ACS_APGCC_AMF_DispatchFlagsT p_dFlag){  // IN
	...
	if (SA_AIS_OK != errorCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:saAmfDispatch FAILEd");
		return ACS_APGCC_FAILURE ;
	}
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::finalize( ) {
	...
	if (SA_AIS_OK != errorCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:saAmfHealthcheckStop FAILED");
		return ACS_APGCC_FAILURE ;
	}
	...
	if (SA_AIS_OK != errorCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:saAmfComponentUnregister FAILED");
		return ACS_APGCC_FAILURE ;
	}
	...
	if (SA_AIS_OK != errorCode) {							
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:saAmfFinalize FAILED");
		return ACS_APGCC_FAILURE ;
	}
...
/*===================================================================
	ROUTINE:  finalize
=================================================================== */
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::AmfFinalize(){
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::performStateTransitionToActiveJobs (ACS_APGCC_AMF_HA_StateT prevousHaState) { //IN
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::performStateTransitionToPassiveJobs (ACS_APGCC_AMF_HA_StateT prevousHaState) { //IN
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::performStateTransitionToQueisingJobs(ACS_APGCC_AMF_HA_StateT prevousHaState){ //IN
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::performStateTransitionToQuiescedJobs(ACS_APGCC_AMF_HA_StateT prevousHaState){ //IN
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::performComponentTerminateJobs( ) {
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::performComponentRemoveJobs( ) {
...
ACS_APGCC_HA_ReturnType APOS_HA_RdeAgent_AmfClass::activate(){
	...
	if (coreMWInitialize() != ACS_APGCC_SUCCESS){
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:coreMWInitialize FAILED");
	...
	if ( (pipe(shutdownPipeFd)) < 0) {
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:pipe creation FAILED");
		return ACS_APGCC_HA_FAILURE;
	}
	
	if ( (fcntl(shutdownPipeFd[0], F_SETFL, O_NONBLOCK)) < 0) {
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass: pipe fcntl on readn");
		return ACS_APGCC_HA_FAILURE;
	}

	if ( (fcntl(shutdownPipeFd[1], F_SETFL, O_NONBLOCK)) < 0) {
		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass: pipe fcntl on writen");
		return ACS_APGCC_HA_FAILURE;
	}
	...
	while (Is_haStarted){
		...
		if(retval == -1){
			if (errno == EINTR)
				continue;
			syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:poll FAILED [%s]",strerror(errno)); 
			Is_haStarted = FALSE;
			continue;
		}
		...
		if(retval == 0){
			...
			syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:timeout happend on poll");
			continue;
		}
		
		if ( fds[FD_AMF].revents & POLLIN){
			if (dispatch(ACS_APGCC_AMF_DISPATCH_ALL) != ACS_APGCC_SUCCESS){
				syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:dispatch FAILED");
				Is_haStarted = FALSE;
				continue;
			}
		...
		if (fds[FD_USR2].revents & POLLIN){
			if (performApplicationShutdownJobs() != ACS_APGCC_SUCCESS){
				syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:performApplicationShutdownJobs FAILED");
			}
			Is_haStarted = FALSE;
		}
	...
	if (this->termAppEventReceived == TRUE){
		if (AmfFinalize() != ACS_APGCC_SUCCESS){
			syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass:AmfFinalize FAILED");
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::performApplicationShutdownJobs(){
...
===================================================================== */
void APOS_HA_RdeAgent_AmfClass::registerApplicationShutdownhandler(int sig){
	(void)sig;

	syslog(LOG_INFO, "APOS_HA_RdeAgent_AmfClass::Shutting down the application.( USR2)");
...
void APOS_HA_RdeAgent_AmfClass::daemonize(const char* daemon_name, const char* userName){
	...
	/* Drop user if there is one, and we were run as root */
    	if ( getuid() == 0 || geteuid() == 0 ) {
        	...
        	if ( pw ) {
            		syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass::Setting user to [%s]",userName );
            		setuid( pw->pw_uid );
        	}
    	}
        ...
        pid = fork();
        if (pid < 0) {
                syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass::Fork daemon failed, pid=%d (%s)", pid, strerror(errno));
                exit(EXIT_FAILURE);
        }
        ...
        sid = setsid();
        if (sid < 0) {
                syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass::Create new session failed, sid=%d (%s)", sid, strerror(errno));
                exit(EXIT_FAILURE);
        }

        /* Redirect standard files to /dev/null */
        if (freopen("/dev/null", "r", stdin) == NULL){
                syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass::freopen stdin failed - %s", strerror(errno));
	}
        if (freopen("/dev/null", "w", stdout) == NULL) {
                syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass::freopen stdout failed - %s", strerror(errno));
	}
        if (freopen("/dev/null", "w", stderr) == NULL) {
                syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass::freopen stderr failed - %s", strerror(errno));
	}
         ...
         */
        if (chdir("/") < 0) {
                syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass::unable to change directory, dir=%s (%s)", "/", strerror(errno));
                exit(EXIT_FAILURE);
        }
...
ACS_APGCC_ReturnType APOS_HA_RdeAgent_AmfClass::__create_pidfile(const char* pidfile) {
        ...
        if ( ((fd = open(pidfile, O_RDWR|O_CREAT, 0644)) == -1)
                ...
                syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass::Open failed, pidfile:[%s], err:[%s]", pidfile, strerror(errno));
                return ACS_APGCC_FAILURE;
        }

        /* Lock the file */
        if (flock(fd, LOCK_EX|LOCK_NB) == -1) {
                syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass::flock failed, pidfile:[%s], err:[%s]", pidfile, strerror(errno));
                fclose(file);
                return ACS_APGCC_FAILURE;
        }
        ...
        pid = getpid();
        if (!fprintf(file,"%d\n", pid)) {
                syslog(LOG_ERR, "APOS_HA_RdeAgent_AmfClass::fprintf failed, pidfile:[%s], err:[%s]", pidfile, strerror(errno));
                fclose(file);
                return ACS_APGCC_FAILURE;
        }
        fflush(file);
