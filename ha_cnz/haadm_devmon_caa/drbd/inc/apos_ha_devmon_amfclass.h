...
#ifndef APOS_HA_DEVMON_AMFCLASS_H_
#define APOS_HA_DEVMON_AMFCLASS_H_
...
/* ================================================================== */
/**
      @brief	The APOS_HA_Devmon_AmfClass class provides the interfaces to the 
		 APG aplications to integrate with Availability Management Framework of CoreMW.
*/
/*=================================================================== */

class APOS_HA_Devmon_AmfClass {
...
public:
	...
	*/
	/*=================================================================== */
		APOS_HA_Devmon_AmfClass()
		{
			 hCheckKey=0;
			 daemonName=0;
		};
	/*=================================================================== */
		APOS_HA_Devmon_AmfClass( const char* daemon_name, 
	...
	*/
	/*=================================================================== */	
			virtual ~APOS_HA_Devmon_AmfClass() { };
	/*=================================================================== */
	/**
...
#endif /* end of APOS_HA_DEVMON_AMFCLASS_H_ */
